...
declare namespace sjcl {
  ...
  type SjclExceptionFactory = new (message: string) => Error
  ...
  type SjclCipherStatic = new (key: number[]) => SjclCipher
  ...
  type SjclPRFFamilyStatic = new (key: BitArray) => SjclPRFFamily

  type SjclHMACStatic = new (key: BitArray, Hash?: SjclHashStatic) => SjclHMAC
  ...
  type SjclEllipticalPointStatic = new (
  ...
  type SjclEllipticalCurveStatic = new (
    Field: BigNumber,
    r: BigNumber,
    a: BigNumber,
    b: BigNumber,
  ...
  type SjclECCPublicKeyFactory<T extends SjclECCPublicKey> = new (curve: SjclEllipticalCurve, point: SjclEllipticalPoint | BitArray) => T

  type SjclECCSecretKeyFactory<T extends SjclECCSecretKey> = new (curve: SjclEllipticalCurve, exponent: BigNumber) => T
  ...
  type SjclRandomStatic = new (defaultParanoia: number) => SjclRandom
  ...
  namespace TypeHelpers {
    ...
    type Two<T1, T2> = (x: T1, N: T2) => BigNumber
