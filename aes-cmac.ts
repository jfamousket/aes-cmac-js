...
export class AesCmac {
  ...
  private cipher: sjcl.SjclCipher;
   ...
   *
   */
  xor4Words = (x: sjcl.BitArray, y: sjcl.BitArray) => {
   ...
   *
   */
  simpleShiftLeft = (a: sjcl.BitArray, shift: number) => {
   ...
   */
  iso7816d4Padding = (message: sjcl.BitArray) => {
